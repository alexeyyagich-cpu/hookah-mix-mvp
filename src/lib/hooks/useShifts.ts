...
const DEMO_SHIFTS: Shift[] = [
  {
    ...
    closing_cash: 420,
    open_notes: null,
    close_notes: 'Спокойный вечер, 2 VIP-стола',
    status: 'closed',
  ...
  },
  {
    ...
    starting_cash: 200,
    closing_cash: 685,
    open_notes: 'Пятница, ожидается загрузка',
    close_notes: 'Полная посадка с 21:00, доп. стулья',
    status: 'closed',
  ...
  },
  {
    ...
    starting_cash: 200,
    closing_cash: 740,
    open_notes: 'Суббота, live DJ с 22:00',
    close_notes: 'Рекордная выручка, закончился Tangiers Cane Mint',
    status: 'closed',
  ...
  },
  {
    ...
    closing_cash: 355,
    open_notes: null,
    close_notes: 'Воскресенье, тихий вечер',
    status: 'closed',
  ...
  },
  {
    ...
    closing_cash: 530,
    open_notes: null,
    close_notes: 'Два корпоратива, хорошие чаевые',
    status: 'closed',
  ...
  },
  {
    ...
    starting_cash: 200,
    closing_cash: null,
    open_notes: 'Среда, ожидаем 3 брони',
    close_notes: null,
    status: 'open',
