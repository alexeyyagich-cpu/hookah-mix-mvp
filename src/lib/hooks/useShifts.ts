...
const DEMO_SHIFTS: Shift[] = [
  {
    ...
    location_id: null,
    opened_by: 'demo',
    opened_at: new Date(Date.now() - 32 * 60 * 60 * 1000).toISOString(),
  ...
  },
  {
    ...
    location_id: null,
    opened_by: 'demo',
    opened_at: new Date(Date.now() - 56 * 60 * 60 * 1000).toISOString(),
    closed_at: new Date(Date.now() - 50 * 60 * 60 * 1000).toISOString(),
    starting_cash: 150,
    closing_cash: 310,
    open_notes: null,
    close_notes: null,
