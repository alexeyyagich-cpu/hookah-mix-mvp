...
const DEMO_SESSIONS: SessionWithItems[] = [
  // Today - 2 sessions
  {
    ...
    total_grams: 20, compatibility_score: 92, notes: null, rating: 5, duration_minutes: 52, selling_price: 15,
    session_items: [
  ...
  // 3 days ago - 2 sessions
  {
    ...
    total_grams: 20, compatibility_score: 95, notes: 'Great mix!', rating: 5, duration_minutes: 55, selling_price: 25,
    session_items: [
  ...
  },
  {
    ...
    total_grams: 15, compatibility_score: 75, notes: null, rating: 3, duration_minutes: 30, selling_price: 12,
    session_items: [
...
const DEMO_INVENTORY: TobaccoInventory[] = [
  ...
  { id: '4', profile_id: 'demo', tobacco_id: 'ds2', brand: 'Darkside', flavor: 'Bananapapa', quantity_grams: 45, purchase_price: 18, package_grams: 100, purchase_date: new Date(Date.now() - 21 * _D).toISOString(), expiry_date: new Date(Date.now() + 160 * _D).toISOString(), notes: 'Low stock!', created_at: new Date(Date.now() - 21 * _D).toISOString(), updated_at: new Date().toISOString() },
