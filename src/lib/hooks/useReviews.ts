...
const DEMO_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    text: 'Лучшая кальянная в городе! Атмосфера на высоте, персонал всегда приветливый.',
    is_published: true,
  ...
  },
  {
    ...
    rating: 5,
    text: 'Обожаю это место! Уютный интерьер, вкусные кальяны и отличная музыка.',
    is_published: true,
  ...
  },
  {
    ...
    rating: 4,
    text: 'Хороший выбор табаков и профессиональные кальянщики. Приду ещё!',
    is_published: true,
  ...
  },
  {
    ...
    rating: 5,
    text: 'Праздновали здесь день рождения — всё было идеально!',
    is_published: false,
