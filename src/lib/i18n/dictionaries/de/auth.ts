...
export const auth: typeof AuthType = {
  ...
  feature2Desc: 'Erstellen Sie perfekte Mixes mit KI-Empfehlungen. Speichern Sie Ihre Lieblingsrezepte.',
  ...
  footerAiRecommendations: 'KI-Empfehlungen',
  ...
  faqQ3: 'Gibt es eine Testphase für Pro?',
  faqA3: 'Ja, neue Benutzer erhalten eine 14-tägige Pro-Testphase ohne Einschränkungen und ohne Karte.',
