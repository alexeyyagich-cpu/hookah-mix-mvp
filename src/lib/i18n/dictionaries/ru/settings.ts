export const settings = {
  ...
  trialEndsOn: (date: string) => `Пробный период до: ${date}`,
  activatingSubscription: 'Активируем подписку…',
  ...
  disconnectWarning: 'Вы уверены, что хотите отключить эту интеграцию? Вы сможете подключить её снова позже.',
