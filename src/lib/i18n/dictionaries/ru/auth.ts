export const auth = {
  ...
  heroSubtitle: 'Учёт табака и бара, создание миксов с AI, рецепты коктейлей, аналитика и гостевая база — всё в одном приложении для вашего заведения',
  ...
  benefit2Desc: 'Готовые миксы, быстрые заказы коктейлей и история предпочтений гостей',
  benefit3Stat: '100%',
