            ...
            >
              ...
              <div className="flex gap-1 ml-2 shrink-0">
                <button type="button"
                  ...
                  className="min-w-[44px] min-h-[44px] p-2.5 rounded hover:bg-[var(--color-primary)]/10 text-[var(--color-primary)] transition-colors flex items-center justify-center"
                  title={tc.retry}
                  aria-label={tc.retry}
                >
                ...
                <button type="button"
                  ...
                  className="min-w-[44px] min-h-[44px] p-2.5 rounded hover:bg-[var(--color-error)]/10 text-[var(--color-textMuted)] transition-colors flex items-center justify-center"
                  title={tc.delete}
