...
export function GuestDetailModal({ guest, bonusHistory, onClose, onUpdate, onDelete }: GuestDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" role="button" tabIndex={-1} aria-label="Close" onClick={onClose} onKeyDown={(e) => e.key === 'Escape' && onClose()}>
      <div
