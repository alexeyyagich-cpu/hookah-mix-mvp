...
export function AddBarIngredientModal({ isOpen, onClose, onSave, editingItem, canAddMore }: AddBarIngredientModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div ref={modalRef} role="dialog" aria-modal="true" aria-labelledby="add-bar-ingredient-title" className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl bg-[var(--color-bgCard)] border border-[var(--color-border)] shadow-xl animate-fadeInUp">
