    ...
    <div className="space-y-6">
      ...
      {showOpenModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/50" role="button" tabIndex={-1} aria-label="Close" onClick={() => setShowOpenModal(false)} onKeyDown={(e) => e.key === 'Escape' && setShowOpenModal(false)} />
      ...
      {showCloseModal && activeShift && closeReconciliation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/50" role="button" tabIndex={-1} aria-label="Close" onClick={() => setShowCloseModal(false)} onKeyDown={(e) => e.key === 'Escape' && setShowCloseModal(false)} />
      ...
      {selectedShift && selectedReconciliation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/50" role="button" tabIndex={-1} aria-label="Close" onClick={() => setSelectedShift(null)} onKeyDown={(e) => e.key === 'Escape' && setSelectedShift(null)} />
          <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-2xl bg-[var(--color-bgCard)] border border-[var(--color-border)] shadow-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
