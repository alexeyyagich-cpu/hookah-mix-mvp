...
export const MIX_RECIPES: MixRecipe[] = [
  // === REFRESHING MIXES ===
  {
    ...
    category: "refreshing",
    ingredients: [
      { flavor: "Pinkman", brand: "Musthave", percent: 40, category: "berry" },
      { flavor: "Bananapapa", brand: "Darkside", percent: 40, category: "fruit" },
      { flavor: "Supernova", brand: "Darkside", percent: 20, category: "mint" },
    ],
  ...
  },
  {
    ...
    category: "refreshing",
    ingredients: [
      { flavor: "Torpedo", brand: "Darkside", percent: 70, category: "fruit" },
      { flavor: "Supernova", brand: "Darkside", percent: 30, category: "mint" },
    ],
  ...
  // === EXOTIC MIXES ===
  {
    ...
    ingredients: [
      ...
      { flavor: "Grapefruit", brand: "Musthave", percent: 25, category: "citrus" },
      { flavor: "Supernova", brand: "Darkside", percent: 15, category: "mint" },
    ],
  ...
  // === WINTER SPECIAL ===
  {
    ...
    category: "refreshing",
    ingredients: [
      { flavor: "Elka", brand: "Black Burn", percent: 40, category: "herbal" },
      { flavor: "Wild Forest", brand: "Darkside", percent: 35, category: "berry" },
      { flavor: "Supernova", brand: "Darkside", percent: 25, category: "mint" },
    ],
